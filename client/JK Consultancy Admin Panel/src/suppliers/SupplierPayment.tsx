...
const SupplierPayment: React.FC<SupplierPaymentProps> = ({ supplier, onClose, onSuccess, createdBy }) => {
  ...
  const totalAmount = supplier.Amount;
        ...
        <div className="mb-2">
          <div className="bg-blue-50 p-2 rounded-md mb-2">
            <p className="text-xs text-blue-800">
              Approving payment of ₹{parseFloat(paymentData.paymentAmount || '0').toLocaleString('en-US')} for {supplier.Name}. Verify with your password.
            </p>
          </div>
