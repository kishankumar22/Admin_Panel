      ...
      <form onSubmit={handleSubmit}>
        <div className="mb-2">
          ...
          <input
            ...
            className={`w-full p-1.5 text-sm border rounded-md focus:outline-none focus:ring-1 focus:ring-blue-500 dark:bg-gray-600 ${
              user.name && !/^[A-Za-z\s]{2,50}$/.test(user.name) ? 'border-red-500' : 'border-gray-300'
            }`}
          />
        ...
        <div className="mb-2">
          ...
          <input
            ...
            className={`w-full p-1.5 text-sm border rounded-md focus:outline-none focus:ring-1 focus:ring-blue-500 dark:bg-gray-600 ${
              user.mobileNo && !/^[0-9]{10}$/.test(user.mobileNo) ? 'border-red-500' : 'border-gray-300'
            }`}
          />
        ...
        <div className="mb-2">
          ...
          <select
            ...
            onChange={handleChange}
            required
            className={`w-full p-1.5 text-sm border dark:bg-gray-600 rounded-md focus:outline-none focus:ring-1 focus:ring-blue-500 ${
              user.roleId === '' && user.roleId !== undefined ? 'border-red-500' : 'border-gray-300'
            }`}
          >
