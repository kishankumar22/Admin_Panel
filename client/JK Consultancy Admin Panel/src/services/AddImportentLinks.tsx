...
const canRead   = userPermissions?.canRead   ?? defaultPermission;
  ...
  {/* Add Link Button */}
  <button
    className={`px-3 py-2 flex items-center justify-center gap-2 text-sm text-white rounded-md transition duration-200 focus:outline-none focus:ring-2 focus:ring-blue-400 ${
    ...
    disabled={!canCreate}
  >
    <MdAddLink className="text-lg" />
    Add Link
  </button>
</div>

      {/* Uploaded Links Section */}
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 dark:bg-meta-4">
            ...
            <div key={link.id} className="p-2 border dark:text-white dark:font-normal dark:text-opacity-50 rounded overflow-hidden">
                <div className="text-sm p-1 mt-1">
                    <img
                        src={link.LOGOUrl}
                        alt={link.logoName}
                        className="w-24 h-24 object-fit" // Changed object-fit to object-cover for better responsiveness
  ...
  >
    <div className="relative p-5 w-full max-w-md bg-white dark:bg-meta-4 rounded-lg shadow-md">
      {/* Modal Header */}
      <h3 className="mb-3 text-center bg-slate-300 p-2 rounded-md text-lg font-bold dark:text-meta-5 text-blue-800">
        Edit Link
      </h3>

      {/* Link Name */}
      <label className="font-semibold text-sm">Link Name</label>
      <input
        type="text"
      ...
      {/* Link URL */}
      <label className="font-semibold text-sm mt-3">Link URL</label>
      <input
        type="text"
      ...
      {/* Logo Upload */}
      <label className="font-semibold text-sm mt-3">Logo</label>
      <input
        type="file"
        className="w-full p-2 border dark:bg-meta-4 border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
      ...
      {/* Logo Position */}
      <label className="font-semibold text-sm mt-3">Logo Position</label>
      <input
        type="number"
        className="w-full p-2 border dark:bg-meta-4 border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
      ...
      <div className="flex justify-between mt-5">
        <button
          ...
          className={`px-4 py-2 w-48 text-white bg-green-500 rounded-md ${
            isUploading ? 'bg-gray-400 cursor-not-allowed' : 'hover:bg-green-600'
          }`}
  ...
  >
    <div className="relative p-5 w-full max-w-md bg-white dark:bg-meta-4 rounded-lg shadow-md">
      ...
      <div className="flex justify-between mt-5">
        <button
          className={`px-4 py-2 w-48 text-white bg-blue-500 rounded-md ${
...
>
  ...
  <Modal.Body>
    <div className="text-center  p-5">
      ...
      <h3 className="mb-5 text-lg font-semibold text-gray-900 dark:text-gray-300">
